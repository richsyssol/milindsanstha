...
<section class="py-5">
    <div class="container">
        <div class="text-center">
            <h1 class="fw-bold">OUR <span class="head">WORK</span></h1>
        </div>
        <div class="row pt-5">
            <?php
                $sql = "SELECT * FROM `our_work` WHERE `status` = 'active' ORDER BY `id` DESC";
                    ...
                    <div class="col-md-4 pt-3">
                        <div class="card">
                          ...
                          <div class="card-body">
                            ...
                            <a href="work-detail?id=<?php echo $row['id']; ?>" class="btn btn-outline-success">READ MORE</a>
