...
<div class="container">
    ...
    <div class="row">
        ...
        <!-- Sidebar -->
        <div class="col-md-4">
            <h4 class="head1 fw-bold">OTHER WORK</h4>
            <ul class="list-group">
                <?php
                ...
                while ($row = mysqli_fetch_assoc($result)){
                    ...
                    <li class="list-group-item"><a href="work-detail?id=<?php echo $row['id']; ?>" class="text-decoration-none text-dark"><?php echo $row['head']; ?></a></li>
...
<section class="py-5">
    <div class="container">
        <div class="text-center">
            <h1 class="fw-bold head">PHOTO'S</h1>
        </div>
        <div class="row pt-5">
            <?php
                
                $id = intval($_GET['id']);
                    $sql = "SELECT * FROM `work_images` WHERE work_images.head_id=$id";
                $result = mysqli_query($conn, $sql);
                $isFirst = true; // Add a flag for the first item
                ...
                while ($row = mysqli_fetch_assoc($result)){
                    ...
                    <div class="col-md-3">
                        <img src="<?php echo  'admin/'.$row['image']; ?>" alt="" class="shadow img-fluid open-modal work-img">
                    </div>
