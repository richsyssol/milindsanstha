...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a>Certificate</a></li>
        </ol>
        </nav>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="certificates-add" class="btn btn-primary">Add Certificates</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="certificates-edit?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                            </tr>
                        <?php 
                        }
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'certificates-delete.php?id=' + deleteId;
    });
});
</script>
