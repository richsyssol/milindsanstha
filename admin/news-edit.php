...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        if ($id) {
            ...
            $sql = "UPDATE `news` SET `image`='$upload_file', `status`='$status' WHERE `id`=$id";
            $result = mysqli_query($conn, $sql);
...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        <div class='container-fluid'>
            <!-- page title -->
            <div class='container-fluid'>
                <h1><?php echo $id ? "Edit" : "Add"; ?> News</h1>
            </div>
            <!-- breadcrumb -->
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><?php echo $id ? "Edit" : "Add"; ?> News</li>
                </ol>
            </nav>
            <!-- form -->
