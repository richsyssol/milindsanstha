...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a>Our Work</a></li>
        </ol>
        </nav>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="work-add" class="btn btn-primary">Add Our Work</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                    ...
                    include 'include/db_conn.php';
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="work-img?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-plus"></i></a>&nbsp; / &nbsp;
                                    <a href="#" data-id="<?php echo $row['id']; ?>" class="deleteBtn"><i class="fa-solid fa-trash"></i></a> &nbsp; / &nbsp;
                                    <a href="work-edit?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'work-delete.php?id=' + deleteId;
    });
});
</script>
