...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <div class='container-fluid'>
            <h1>About Milind Samajik Sanstha</h1>
        </div>
        <!-- breadcrumb -->
        <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
            <li class="breadcrumb-item"><a>About Milind Samajik Sanstha</a></li>
        </ol>
        </nav>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    include 'include/db_conn.php';
                        $sql = "SELECT * FROM `milind_sanstha`";
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="about-edit?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                            </tr>
                        <?php 
                        }
