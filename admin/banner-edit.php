...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        if ($id) {
            ...
            $sql = "UPDATE `banner` SET `image`='$upload_file', `head`='$head',`para`='$para', `status`='$status' WHERE `id`=$id";
            $result = mysqli_query($conn, $sql);
            ...
            <div class="container pt-5 w-50">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="head" class="form-control" id="exampleFormControlInput1" placeholder="abc.com" value="<?php echo $head; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Paragraph</label>
                        <input type="text" name="para" class="form-control" id="exampleFormControlInput1" placeholder="abc.com" value="<?php echo $para; ?>" required>
                    </div>
                    <div class="mb-3">
