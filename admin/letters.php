...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a>Letters</a></li>
        </ol>
        </nav>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="letters-add" class="btn btn-primary">Add Letters</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="letters-edit?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                            </tr>
                        <?php 
                        }
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'letters-delete.php?id=' + deleteId;
    });
});
</script>
