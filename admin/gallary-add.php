...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        if (move_uploaded_file($image_tmp, $upload_file)) {
            ...
            $sql = "INSERT INTO `photo`(`id`, `image`, `image_type_id` , `status`) VALUES (NULL, '$upload_file', '$image_type_id' , '$status')";
    ...
    <div class='dashboard-content'>
        ...
        <!-- page title -->
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="gallary">Gallary</a></li>
                <li class="breadcrumb-item"><a>Add Gallary</a></li>
            </ol>
            </nav>
            <!-- form -->
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Image Type</label>
                    <select class="form-select" name="image_type_id" aria-label="Default select example">
                        <?php
                            include 'include/db_conn.php';
