...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        if ($id) {
            ...
            $sql = "UPDATE `our_work` SET `image`='$upload_file', `head`='$head' , `para`='$para' , `status`='$status' WHERE `id`=$id";
            $result = mysqli_query($conn, $sql);
            ...
            // Insert new record
            $sql = "INSERT INTO `our_work`(`id`, `image`, `head` , `para` , `status`) VALUES (NULL, '$upload_file', '$head' , '$para' , '$status')";
            $result = mysqli_query($conn, $sql);
...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        <div class='container-fluid'>
            <!-- page title -->
            <div class='container-fluid'>
                <h1><?php echo $id ? "Edit" : "Add"; ?> Our Work</h1>
            </div>
            <!-- breadcrumb -->
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><?php echo $id ? "Edit" : "Add"; ?> Our Work</li>
                </ol>
            </nav>
            <!-- form -->
