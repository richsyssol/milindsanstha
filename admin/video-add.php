    ...
    <div class='dashboard-content'>
        ...
        <!-- page title -->
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a>Add Video</a></li>
            </ol>
            </nav>
            <!-- form -->
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="url" class="form-control" id="exampleFormControlInput1" placeholder="Enter Youtube URL" required>
                </div>
                <div class="mb-3">
