...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <div class='container-fluid'>
            <h1>About Vilas Katare</h1>
        </div>
        <!-- breadcrumb -->
        <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
            <li class="breadcrumb-item"><a>About Vilas Katare</a></li>
        </ol>
        </nav>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="vilas_katere-add" class="btn btn-primary">Add About Vilas Katare</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                    ...
                    include 'include/db_conn.php';
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
                                        $description_words = explode(" ", $row['about']);
                                ...
                                <td>
                                    ...
                                    <a href="vilas_katere-edit?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                            </tr>
                        <?php 
                        }
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'vilas_katere-delete.php?id=' + deleteId;
    });
});
</script>
