...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        if (!empty($_FILES['image']['name'])) {
            ...
            $upload_dir = 'uploads/letters/'; // Ensure this directory exists and has write permissions
        ...
        if ($id) {
            ...
            $sql = "UPDATE `letters` SET `image`='$upload_file', `status`='$status' WHERE `id`=$id";
            $result = mysqli_query($conn, $sql);
            ...
            // Insert new record
            $sql = "INSERT INTO `letters`(`id`, `image`, `status`) VALUES (NULL, '$upload_file', '$status')";
            $result = mysqli_query($conn, $sql);
...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        <div class='container-fluid'>
            <!-- page title -->
            <div class='container-fluid'>
                <h1><?php echo $id ? "Edit" : "Add"; ?> Letters</h1>
            </div>
            <!-- breadcrumb -->
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="letters">Letters</a></li>
                    <li class="breadcrumb-item" aria-current="page"><?php echo $id ? "Edit" : "Add"; ?> Letters</li>
                </ol>
            </nav>
            <!-- form -->
